...
data "amazon-parameterstore" "role_arn" {
  ...
  name = "/fb/${var.environment}/ci-cd/roles/packer"
}

data "amazon-parameterstore" "instance_profile" {
  region = var.region

  name = "/fb/${var.environment}/ci-cd/config/ServerImages/instance_profile"
}

data "amazon-parameterstore" "ami_users" {
  region = var.region

  name = "/fb/${var.environment}/ci-cd/config/ServerImages/ami_consumers"
}
